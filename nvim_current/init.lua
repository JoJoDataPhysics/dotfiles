...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>y', group = 'Hand[y] Session', mode = { 'n' } },
      },
    },
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sb', builtin.buffers, { desc = '[S]ind [B]uffers' })
      vim.keymap.set('n', '<leader>s.', builtin.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
      vim.keymap.set('n', '<leader>sp', ':Telescope git_files<cr>', { desc = '[S]earch Git Files' })
...
map('i', 'jj', '<ESC>', { desc = 'remaped escape' })
