...
-- python debugger
vim.keymap.set("n", "<leader>dpb", "<cmd>DapToggleBreakpoint <CR>", { desc = "Toggle breakpoint" })
vim.keymap.set("n", "<leader>dpr", "<cmd> lua require('dap-python').test_method()<CR>", { desc = "Run test method" })
